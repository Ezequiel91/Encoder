...
#include "Utilities.h"
extern	bool	flags;
extern	uint16	actualpos;
extern	uint16	quaderr;
...
/*
** ===================================================================
**     Event       :  Q4C1_OnError (module Events)
**
**     Component   :  Q4C1 [QuadCounter]
**     Description :
...
void TI1_OnInterrupt(void)
{
  /* Write your code here ... */
	...
	{
		MAX1_SetVal(0x7ff);
		if(actualpos<pos){MAX1_SetDirection(TRUE);}
		else{MAX1_SetDirection(FALSE);}
	}
	else{MAX1_SetVal(0xffff);}
